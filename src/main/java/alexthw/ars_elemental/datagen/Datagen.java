...
public class Datagen {
    ...
    @SubscribeEvent
        ...
        gen.addProvider(new AEBlockStateProvider(gen, existingFileHelper));
        gen.addProvider(new AEItemModelProvider(gen, existingFileHelper));
        BlockTagsProvider BTP = new AETagsProvider.AEBlockTagsProvider(gen, existingFileHelper);
        gen.addProvider(BTP);
        gen.addProvider(new AETagsProvider.AEItemTagsProvider(gen, BTP, existingFileHelper));
        gen.addProvider(new AETagsProvider.AEEntityTagProvider(gen, existingFileHelper));
        gen.addProvider(new ModRecipeProvider(gen));
        gen.addProvider(new ModLootTables(gen));

        gen.addProvider(new AEImbuementProvider(gen));
        gen.addProvider(new AEGlyphProvider.GlyphProvider(gen));
        gen.addProvider(new AEApparatusProvider(gen));

        gen.addProvider(new AEPatchouliProvider(gen));
        gen.addProvider(new AEAdvancementsProvider(gen, existingFileHelper));

        gen.addProvider(new AETagsProvider.AEBiomeTagsProvider(gen, existingFileHelper));
