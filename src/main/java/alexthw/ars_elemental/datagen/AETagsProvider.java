...
public class AETagsProvider {
    ...
    public static class AEItemTagsProvider extends ItemTagsProvider {
        ...
        protected void addTags() {
            tag(SPELLBOOK).add(ItemsRegistry.NOVICE_SPELLBOOK, ItemsRegistry.APPRENTICE_SPELLBOOK, ItemsRegistry.ARCHMAGE_SPELLBOOK, ItemsRegistry.CREATIVE_SPELLBOOK);
            ...
            tag(PRISM_LENS).add(ModItems.ARC_LENS.get(), ModItems.HOMING_LENS.get(), ModItems.RGB_LENS.get(), ModItems.ACC_LENS.get(), ModItems.DEC_LENS.get());
            tag(ModRegistry.CURIO_BAGGABLE).add(ItemsRegistry.WORN_NOTEBOOK, ItemsRegistry.DOMINION_ROD, ItemsRegistry.DOWSING_ROD, ItemsRegistry.JAR_OF_LIGHT, ItemsRegistry.VOID_JAR, ItemsRegistry.RUNIC_CHALK, ItemsRegistry.WARP_SCROLL, ItemsRegistry.SPELL_PARCHMENT).addTag(SUMMON_SHARDS).addTag(PRISM_LENS);
    ...
    public static class AEBiomeTagsProvider extends BiomeTagsProvider {
        ...
        protected void addTags() {
            ...
            //this.tag(SIREN_SPAWN_TAG).addTag(BiomeTags.HAS_OCEAN_MONUMENT).add(new ResourceLocation(ArsNouveau.MODID, "archwood_forest"));
    ...
    public static class AEEntityTagProvider extends EntityTypeTagsProvider {
        ...
        protected void addTags() {
            ...
            this.tag(ModRegistry.AERIAL).add(EntityType.PHANTOM, EntityType.WITHER, EntityType.BAT, EntityType.ENDER_DRAGON, EntityType.PARROT, EntityType.GHAST, EntityType.VEX, EntityType.BEE, ModEntities.WILDEN_STALKER, ModEntities.WILDEN_BOSS);
            ...
            this.tag(ModRegistry.AQUATIC).add(EntityType.AXOLOTL, EntityType.DROWNED);
