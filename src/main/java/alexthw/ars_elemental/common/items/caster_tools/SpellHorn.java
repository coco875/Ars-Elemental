    ...
    public void releaseUsing(ItemStack stack, Level pLevel, LivingEntity pLivingEntity, int remainingTicks) {
        ...
        if (j >= getMinUseDuration() && pLivingEntity instanceof Player player) {
            ...
            if (pLevel instanceof ServerLevel) {
                ...
                SpellResolver resolver = new SpellResolver(new SpellContext(caster.getSpell(), pLivingEntity).withType(SpellContext.CasterType.ENTITY));
                resolver.onCast(ItemStack.EMPTY, pLevel);
                ...
                resolver.expendMana(pLivingEntity);
            }
