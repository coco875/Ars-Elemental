...
public class ModPotions {
    ...
    static {
        ...
        ENDERFERENCE_POTION = POTIONS.register("enderference_potion", () -> new Potion(new MobEffectInstance(ENDERFERENCE.get(), 400)));
        LONG_ENDERFERENCE_POTION = POTIONS.register("enderference_long", () -> new Potion(new MobEffectInstance(ENDERFERENCE.get(), 1200)));
        SHOCK_POTION = POTIONS.register("shock_potion", () -> new Potion(new MobEffectInstance(LIGHTNING_LURE.get(), 600)));
        LONG_SHOCK_POTION = POTIONS.register("shock_long", () -> new Potion(new MobEffectInstance(LIGHTNING_LURE.get(), 400)));
